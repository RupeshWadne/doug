    ...
    <>
      <div className="flex bg-[#2F1313] md:px-20 px-4 justify-between items-center">
        <div className="flex justify-between items-center w-1/4">
          ...
          <a href="#about"><p className="cursor-pointer hidden md:flex">About</p></a>
          <a href="#contact"><p className="cursor-pointer hidden md:flex">Contact Us</p></a>
        </div>
      ...
      {!toggle ? (
        ...
        <div className="md:hidden flex border-t-2 border-black bg-[#2F1313] flex-col justify-between p-4 gap-4 w-full h-full">
          <a href="#about"><p className="cursor-pointer flex">About</p></a>
          <a href="#contact"><p className="cursor-pointer flex">Contact Us</p></a>
